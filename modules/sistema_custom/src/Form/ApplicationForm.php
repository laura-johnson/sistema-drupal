...
class ApplicationForm extends FormBase {
  ...
  $field = array();
    ...
    $student = Node::load($field['student_nid']);
          ...
          if ($student->field_student_status->value == 'Attending 15/16' || $student->field_student_status->value == 'Attending 16/17') {
            $student->field_student_status->value = 'Attending 16/17';
          }
          else {
	  ...
	  'title'       	=> $field['first'] . ' ' . $field['last'] . ' Application ' . date('Y'),
           ...
           if ($student->field_student_status->value == 'Attending 16/17') {
             $mailtype = 'ReturningStudent';
             drupal_set_message($studentname . ' is now enrolled in the Sistema Toronto 2016/17 program.');
           }
           else {
             $mailtype = 'NewStudent';
...
function SistemaMail($mailtype, $studentfirst, $studentname, $school) {
  ...
  $subject = SafeMarkup::checkPlain(t('You have submitted a Sistema Toronto application for @studentname', array('@studentname' => $studentname)));

if ($mailtype == 'NewStudent') {

  $body = SafeMarkup::checkPlain(t(

'Thank you for submitting a Sistema Toronto 2016/17 registration for:
<br><br>
@studentname
<br><br>
This year we will have room for 12-15 new students in our program at @school. Because we typically receive more than 15 applications each year, selection will take place by lottery. We will be in touch in late April/early May to let you know if @studentfirst has been selected into the 2016/17 Sistema Toronto program.
<br><br>
All the best!
<br><br>
...
'Thank you for renewing Sistema Toronto 2016/17 registration for:
<br><br>
@studentname
<br><br>
We\'re looking forward to another great year of music and community at @school! We will be in touch in late April/early May with details about the 2016/17 Sistema Toronto program.
<br><br>
All the best!
<br><br>
The Sistema Toronto Team', array(
